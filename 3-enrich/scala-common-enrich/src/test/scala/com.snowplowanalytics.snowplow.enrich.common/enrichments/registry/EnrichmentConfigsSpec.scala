...
class EnrichmentConfigsSpec extends Specification with ValidationMatchers {
  ...
  "Parsing a valid pii_pseudonymizer_config enrichment JSON" should {
    "successfully construct a PiiPsedonymizerEnrichment case object" in {
      ...
      val schemaKey = SchemaKey("com.snowplowanalytics.snowplow.enrichments", "pii_pseudonymizer_config", "jsonscehma", "1-0-0")
